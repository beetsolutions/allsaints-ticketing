    ...
    return (
        ...
        >
            ...
            >
                ...
                <WithRecord label="Download" render={record => record.paymentStatus === 'SOLD' ? (<Button sx={{ color: "#000"}} type='submit' onClick={() => ticket(record.id, record.type)}  label='Download'/>) : null} />
            </Datagrid>
            ) : (
                <Datagrid
                    expand={<TicketsEditEmbedded />}
