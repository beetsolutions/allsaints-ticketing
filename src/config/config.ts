...
const apiUrl = 'http://ec2-3-80-222-79.compute-1.amazonaws.com/allsaints/api/v1';
...
export const authProvider: AuthProvider = {
    login: ({phoneNumber, otp}) => {
        ...
        let url = 'http://ec2-3-80-222-79.compute-1.amazonaws.com/allsaints/api/v1/sms/request';

        if (phoneNumber && otp) {
            url = 'http://ec2-3-80-222-79.compute-1.amazonaws.com/allsaints/api/v1/sms/verify'
        }
